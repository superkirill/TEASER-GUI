...
net_arg.add_argument('--log_path', type=str, default='../smooth_net/logs',
                     help='path to the directory with the tensorboard logs')
# -----------------------------------------------------------------------------
# Test
test_arg = add_argument_group("Evaluate")
test_arg.add_argument("--evaluate_input_folder", type=str, default="../smooth_net/data/evaluate/input_data/",
                          help='prefix for the input folder locations')
test_arg.add_argument("--parametrization1", type=str, default="cloud1.csv",
                        help='name of the parametrization file for the first cloud')
test_arg.add_argument("--parametrization2", type=str, default="cloud2.csv",
                        help='name of the parametrization file for the second cloud')
test_arg.add_argument("--evaluate_output_folder", type=str, default="../smooth_net/data/evaluate/output_data/",
                          help='prefix for the output folder locations')
test_arg.add_argument('--evaluation_batch_size', type=int, default=200,
                          help='the number of examples for each iteration of inference')
test_arg.add_argument('--saved_model_dir', type=str, default='../smooth_net/models/',
...
train_arg.add_argument("--input_data_folder", type=str, default="../smooth_net/data/train/input_data/",
                      help='prefix for the input folder locations')
train_arg.add_argument("--output_data_folder", type=str, default="../smooth_net/data/train/output_data/",
                      help='prefix for the output folder locations')
...
train_arg.add_argument('--training_data_folder', type=str, default="../smooth_net/data/train/trainingData3DMatch",
                       help='location of the training data files')
train_arg.add_argument('--pretrained_model', type=str, default="../smooth_net/models/32_dim/3DSmoothNet_32_dim.ckpt",
                       help='pretrained model which will be used if resume is activared')

# Validation
valid_arg = add_argument_group("Validation")
train_arg.add_argument('--validation_data_folder', type=str, default="../smooth_net/data/validation/validationData3Dmatch/",
